...
AS $$
DECLARE
  project_url TEXT := 'https://iqpehcvsncnlagnxgrfi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlxcGVoY3ZzbmNubGFnbnhncmZpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NDMxNjA4MiwiZXhwIjoyMDU5ODkyMDgyfQ.GMG72JabpYEX3prR0aljiLV2M9L7-BHuddzFNFE7C9A'; -- full access needed for http request to storage
